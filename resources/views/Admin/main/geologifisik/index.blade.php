...
<div id="main-content">
                        ...
                        <table class="table table-striped" id="table1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>   
                                        <a class="badge bg-warning"   data-bs-toggle="modal" data-bs-target="#edit_data{{ $item->id_geologi_fisik }}">  <i class="fa fa-edit"> </i>  </a>
    ...
    <div class="modal fade" id="edit_data{{ $item1->id_geologi_fisik }}" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable"
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('geologi-fisik.update', $item1->id_geologi_fisik) }}" method="POST">
                    @csrf  @method('put')
