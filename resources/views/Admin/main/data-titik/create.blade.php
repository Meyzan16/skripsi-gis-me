...
function eraseText() {
     document.getElementById("batuan").value = "";
...
function initMap() {
                    ...
                    google.maps.event.addListener(polygon, 'click', function ( event ) {
                            ...
                            console.log(infowindow.setPosition(event.latLng))
                        ...
                        google.maps.event.addListener(marker, 'dragend', function ( event ) 
                        {
                            ...
                            geocoder.geocode( { latLng: marker.getPosition() }, function ( results, status ) {
                                if ( status == google.maps.GeocoderStatus.OK ) {  // This line can also be written like if ( status == google.maps.GeocoderStatus.OK ) {
                                    ...
                                    // if ( marker.getPosition(this.paths)  ) {
                                    //         kecamatan = this.value;
                                    //         document.getElementById('kecamatan').value = kecamatan;
                                    // }

                                    // if(polygon.setPosition(event.latLng) )
                                    // {
                                    //     console.log(polygon.value);
                                    // }
                                    // if(marker.getPosition() === polygon.paths)
                                    // {
