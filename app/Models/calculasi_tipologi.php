...
class calculasi_tipologi extends Model
{
    ...
    protected $fillable = [
        'id_gempa','id_titik' , 'hasil_kali_bobot_geologi_fisik', 'ket_geologi_fisik', 'hasil_kali_bobot_lereng', 'ket_lereng','hasil_pga', 'nilai_kemampuan_pga', 'ket_pga', 'hasil_kali_bobot_pga', 'a', 'c', 'hasil_jarak_struktur_geologi',  'nilai_kemampuan_struktur_geologi', 'ket_struktur_geologi', 
